...
- [ ] **Database — Fail-closed capabilitypreflight:** Schakel TiDB CHECK-enforcement aantoonbaar in, registreer de negen financiële/integriteitsconstraints opnieuw en laat runtime, migratieverificatie en CI duidelijk stoppen wanneer de capability of verwachte constraintset ontbreekt; documenteer oorzaak en herstelpad.
